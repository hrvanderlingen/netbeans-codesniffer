 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Netbeans_Sniffs_Classes_ClassDeclarationSniff extends PEAR_Sniffs_Classes_ClassDeclarationSniff
{
...
//end process()
    ...
    public function processOpen(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($classNames as $i => $className) {
            ...
            if ($checkingImplements === true && $multiLineImplements === true && ($tokens[($className - 1)]['code'] !== T_NS_SEPARATOR || $tokens[($className - 2)]['code'] !== T_STRING)
            ) {
...
//end processOpen()
    ...
    public function processClose(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        /**
         * 
         * Outcommented due to Netbeans incompatability
         * 
